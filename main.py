...
meteor = Spell("Metor", 40, 1200, "black")
quake = Spell("Quake", 32, 1500, "black")
...
superpotion = Item("Super Potion", "potion", "Heals", 1000)
...
enemy1 = Person("Imp   ", 1250, 130, 500,325, [], [])
enemy2 = Person("Maggus", 11200, 701, 525, 25, [], [])
...
while running:
        ...
        if enemy.get_hp() == 0:
            ...
            print(bcolors.FAIL +"Your ennemy has defeated you!" + bcolors.ENDC)
            running = False
